...
## Purpose
Server-persisted operating configuration shared across all clients — the per-machine, per-stage vacuum pressure setpoints, their REST read/write endpoints, validation rules, legacy document expansion, and authentication requirement.
## Requirements
