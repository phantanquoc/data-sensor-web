...
let id_document_plc_8;

exports.postDataPlc_to_noi_chien_8 = async (
  values,
  io_,
  Start_PLC8,
  giai_doan_1,
  ...
  // khởi tạo
  if (Start_PLC8 === 1) {
    const docunent = await PLCData_noi_chien_8.create(dataFormat).catch(
      (err) => {
        console.log(err);
      },
    );
    if (docunent) id_document_plc_8 = docunent._id;
  }
  // update
  if (Start_PLC8 > 1) {
    ...
    if (giai_doan_1 && typeof giai_doan_1 === "boolean") {
      const document = await PLCData_noi_chien_8.findByIdAndUpdate(
        id_document_plc_8,
        {
      ...
      console.log("nồi chiên 8 giai đoạn 1");
    }
    // giai đoạn 2
    if (giai_doan_2 && typeof giai_doan_2 === "boolean") {
      ...
      console.log("nồi chiên 8 giai đoạn 2");
    }
    //giai đoạn 3
    if (giai_doan_3 && typeof giai_doan_3 === "boolean") {
      ...
      console.log("nồi chiên 8 giai đoạn: 3");
    }
    //giai đoạn 4
    if (giai_doan_4 && typeof giai_doan_4 === "boolean") {
      ...
      console.log("nồi chiên 8 giai đoạn 4");
    }
  }
  ...
  if (Start_PLC8 === 0) {
    ...
    io_.emit("noi_chien_8_stop", {
      stop: "đã hoang thành xong mẽ chiên",
    });
  }

  // view realtime
  io_.emit("noi_chien_8_data", {
    data: newData_gd_1,
